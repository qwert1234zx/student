...
<article class="cl pd-20" class="pos-ab">
	<div class="form form-horizontal" >
		...
		<div class='row cl'>
			...
			<div class='formControls col-xs-8 col-sm-9'><input type='text' class='input-text' id='InterviewResult' maxlength='1000' style='width:12000px' value='${InterviewRecord.interviewResult}'></div>
		</div>
		<div class='row cl'>
		...
		<div class='row cl'>
			...
			<div class='formControls col-xs-8 col-sm-9'><input type='text' class='input-text' id='InterviewStatus' maxlength='10' style='width:120px' value='${InterviewRecord.interviewStatus}'></div>
		</div>
		<div class='row cl'>
		...
		<div class='row cl'>
			...
			<div class='formControls col-xs-8 col-sm-9'><input type='text' class='input-text' id='StudentID' maxlength='10' style='width:120px' value='${InterviewRecord.studentID}'></div>
		</div>
		<div class='row cl'>
			<label class='form-label col-xs-4 col-sm-2'><span class='c-red'>*</span>企业ID：</label>
			<div class='formControls col-xs-8 col-sm-9'><input type='text' class='input-text' id='EnterpriseID' maxlength='10' style='width:120px' value='${InterviewRecord.enterpriseID}'></div>
		</div>
...
<script type="text/javascript">
    ...
    function submit() {
        if (validate(regList)) {
            ...
            $.ajax({
                type: "post",
                url: "<%=request.getContextPath()%>/university/statistics/interviewrecord/update",
