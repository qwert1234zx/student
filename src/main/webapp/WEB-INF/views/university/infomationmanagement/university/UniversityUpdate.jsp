...
<article class="cl pd-20" class="pos-ab">
	<div class="form form-horizontal" >
		...
		<div class='row cl'>
			...
			<div class='formControls col-xs-8 col-sm-9'><input type='text' class='input-text' id='Degree' maxlength='10' style='width:120px' value='${University.degreeName}'></div>
		</div>
		<div class='row cl'>
		...
		<div class='row cl'>
			...
			<div class='formControls col-xs-8 col-sm-9'><input type='text' class='input-text' id='ProvinceID' maxlength='10' style='width:120px' value='${University.provinceName}'></div>
		</div>
