...
<article class="cl pd-20" class="pos-ab">
	<div class="form form-horizontal" >
		...
		<div class='row cl'>
			...
			<div class='formControls col-xs-8 col-sm-9'><input type='text' class='input-text' id='FeePerResume' maxlength='10' style='width:120px'></div>
		</div>
		<div class='row cl'>
			<label class='form-label col-xs-4 col-sm-2'><span class='c-red'>*</span>生效日期：</label>
			<div class='formControls col-xs-8 col-sm-9'><input type='text' class='input-text' id='EffectiveDate' maxlength='10' style='width:120px'></div>
		</div>
...
<script type="text/javascript">
    ...
    function submit() {
		if(validate(regList)){
            ...
            $.ajax({
                type: "post",
                url: "<%=request.getContextPath()%>/enterprise/feemanagement/chargerule/insert",
