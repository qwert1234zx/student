...
<article class="cl pd-20" class="pos-ab">
	<div class="form form-horizontal" >
		...
		<div class='row cl'>
			...
			<div class='formControls col-xs-8 col-sm-9'><input type='text' class='input-text' id='Degree' maxlength='10' style='width:120px' value='${University.degree}'></div>
		</div>
		<div class='row cl'>
			<label class='form-label col-xs-4 col-sm-2'>是否双一流：</label>
			<div class='formControls col-xs-8 col-sm-9'><input type='text' class='input-text' id='IsDFG' maxlength='10' style='width:120px' value='${University.isDFG}'></div>
		</div>
		<div class='row cl'>
			<label class='form-label col-xs-4 col-sm-2'>是否211：</label>
			<div class='formControls col-xs-8 col-sm-9'><input type='text' class='input-text' id='IsTOO' maxlength='10' style='width:120px' value='${University.isTOO}'></div>
		</div>
		<div class='row cl'>
			<label class='form-label col-xs-4 col-sm-2'>是否985：</label>
			<div class='formControls col-xs-8 col-sm-9'><input type='text' class='input-text' id='IsNEF' maxlength='10' style='width:120px' value='${University.isNEF}'></div>
		</div>
		<div class='row cl'>
		...
		<div class='row cl'>
			...
			<div class='formControls col-xs-8 col-sm-9'><input type='text' class='input-text' id='ProvinceID' maxlength='10' style='width:120px' value='${University.provinceID}'></div>
		</div>
...
<script type="text/javascript">
    ...
    function submit() {
        if (validate(regList)) {
            ...
            $.ajax({
                type: "post",
                url: "<%=request.getContextPath()%>/enterprise/statistics/university/update",
