...
<article class="cl pd-20" class="pos-ab">
	<div class="form form-horizontal" >
		...
		<div class='row cl'>
			...
			<div class='formControls col-xs-8 col-sm-9'><input type='text' class='input-text' id='StudentRemark' maxlength='2000' style='width:24000px'></div>
		</div>
		<div class='row cl'>
			<label class='form-label col-xs-4 col-sm-2'>学生评价：</label>
			<div class='formControls col-xs-8 col-sm-9'><input type='text' class='input-text' id='StudentRate' maxlength='10' style='width:120px'></div>
		</div>
		<div class='row cl'>
			<label class='form-label col-xs-4 col-sm-2'>面试官评价：</label>
			<div class='formControls col-xs-8 col-sm-9'><input type='text' class='input-text' id='InterviewerRemark' maxlength='1000' style='width:12000px'></div>
		</div>
		<div class='row cl'>
			<label class='form-label col-xs-4 col-sm-2'><span class='c-red'>*</span>面试官结论：</label>
			<div class='formControls col-xs-8 col-sm-9'><input type='text' class='input-text' id='InterviewerConclusion' maxlength='10' style='width:120px'></div>
		</div>
		<div class='row cl'>
		...
		<div class='row cl'>
			...
			<div class='formControls col-xs-8 col-sm-9'><input type='text' class='input-text' id='CandidateID' maxlength='10' style='width:120px'></div>
		</div>
...
<script type="text/javascript">
    ...
    function submit() {
		if(validate(regList)){
            ...
            $.ajax({
                type: "post",
                url: "<%=request.getContextPath()%>/enterprise/interviewmanagement/interviewrecord/insert",
