...
<article class="cl pd-20" class="pos-ab">
	<div class="form form-horizontal" >
		...
		<div class='row cl'>
			...
			<div class='formControls col-xs-8 col-sm-9'><input type='text' class='input-text' id='UserName' maxlength='20' style='width:240px'></div>
		</div>
		<div class='row cl'>
...
<script type="text/javascript">
    ...
    function submit() {
		if(validate(regList)){
            ...
            $.ajax({
                type: "post",
                url: "<%=request.getContextPath()%>/enterprise/recruitormanagement/enterpriseuser/insert",
