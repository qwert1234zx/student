...
<article class="cl pd-20" class="pos-ab">
	<div class="form form-horizontal" >
		...
		<div class='row cl'>
			...
			<div class='formControls col-xs-8 col-sm-9'><input type='text' class='input-text' id='QueryName' maxlength='200' style='width:2400px'></div>
		</div>
		<div class='row cl'>
			<label class='form-label col-xs-4 col-sm-2'><span class='c-red'>*</span>所属企业用户：</label>
			<div class='formControls col-xs-8 col-sm-9'><input type='text' class='input-text' id='EnterpriseUserID' maxlength='10' style='width:120px'></div>
		</div>
...
<script type="text/javascript">
    ...
    function submit() {
		if(validate(regList)){
            ...
            $.ajax({
                type: "post",
                url: "<%=request.getContextPath()%>/enterprise/studentsearch/enterprisequerycondition/insert",
