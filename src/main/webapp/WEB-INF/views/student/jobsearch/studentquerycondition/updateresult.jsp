    ...
    <div class="form form-horizontal" >
        ...
        <div class='row cl'>
            ...
            <div class='formControls col-xs-8 col-sm-9'>
                <input type='text' class='input-text' id='QueryName' maxlength='100' style='width:1200px'>
            </div>
        </div>
   <%List<Integer> proid= (List<Integer>) request.getAttribute("proid");%>
        <input type="text" hidden="hidden" id="id" value="${id}">
        <div class='row cl'>
            <label class='form-label col-xs-4 col-sm-2'><span class='c-red'>*</span>省份名称：</label>
            <div class='formControls col-xs-8 col-sm-9'>
                <select name="srcList"  id="typenum" size="8" multiple>
                    <c:forEach items="${resultProvince}" var="resp" varStatus="status">
                        <option   value="${resp.provinceid}"  selected="selected">${resp.provincename}</option>
                    </c:forEach>
                </select>
            </div>
        </div>
        ...
        <div class='row cl'>
            ...
            <div class='formControls col-xs-8 col-sm-9'>
                <input type='text' class='input-text' id='ssalary' maxlength='100' style='width:1200px'>
            </div>
            <div class='formControls col-xs-8 col-sm-9'>
                <input type='text' class='input-text' id='bsalary' maxlength='100' style='width:1200px'>
            </div>
        </div>
        ...
        <div class='row cl'>
            ...
            <div class='formControls col-xs-8 col-sm-9'>
                <input type='text' class='input-text' id='syear' maxlength='100' style='width:1200px'>
            </div>
            <div class='formControls col-xs-8 col-sm-9'>
                <input type='text' class='input-text' id='byear' maxlength='100' style='width:1200px'>
            </div>
        </div>
