 ...
 * @author Howard
 */
package universityrecruit.enterprise.interviewmanagement.interviewrecord.dao;
...
@Mapper
public interface EntIntInterviewRecordMapper extends BaseMapper<InterviewRecord>{
