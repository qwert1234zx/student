 ...
 * @author Howard
 */
package universityrecruit.enterprise.studentsearch.courserelationship.controller;
...
@Controller
@RequestMapping(value = "/enterprise/studentsearch/courserelationship")
public class EntStuCourseRelationshipController extends BaseController {

    @Resource(name = "EntStuCourseRelationshipService")
    private ICourseRelationshipService oiCourseRelationshipService;

    @Autowired
    public EntStuCourseRelationshipController(ICourseRelationshipService oTempCourseRelationshipService){
    ...
    public String searchAll(Model model, @RequestParam(required = true) Integer pageNum) {
        ...
        return "/enterprise/studentsearch/courserelationship/CourseRelationshipList";
    }
    ...
    public ModelAndView addForward() throws Exception {
        return new ModelAndView("/enterprise/studentsearch/courserelationship/CourseRelationshipAdd");
    }
    ...
    public ModelAndView updateForward(@RequestParam Integer testTableId) throws Exception {
        ...
        return new ModelAndView("/enterprise/studentsearch/courserelationship/CourseRelationshipUpdate", "CourseRelationship", oCourseRelationship);
    }
}
