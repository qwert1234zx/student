 ...
 * @author Howard
 */
package universityrecruit.enterprise.studentsearch.selectivecoursescore.dao;
...
@Mapper
public interface EntStuSelectiveCourseScoreMapper extends BaseMapper<SelectiveCourseScore>{
