 ...
 * @author Howard
 */
package universityrecruit.enterprise.studentsearch.selectivecoursescore.controller;
...
@Controller
@RequestMapping(value = "/enterprise/studentsearch/selectivecoursescore")
public class EntStuSelectiveCourseScoreController extends BaseController {

    @Resource(name = "EntStuSelectiveCourseScoreService")
    private ISelectiveCourseScoreService oiSelectiveCourseScoreService;

    @Autowired
    public EntStuSelectiveCourseScoreController(ISelectiveCourseScoreService oTempSelectiveCourseScoreService){
    ...
    public String searchAll(Model model, @RequestParam(required = true) Integer pageNum) {
        ...
        return "/enterprise/studentsearch/selectivecoursescore/SelectiveCourseScoreList";
    }
    ...
    public ModelAndView addForward() throws Exception {
        return new ModelAndView("/enterprise/studentsearch/selectivecoursescore/SelectiveCourseScoreAdd");
    }
    ...
    public ModelAndView updateForward(@RequestParam Integer testTableId) throws Exception {
        ...
        return new ModelAndView("/enterprise/studentsearch/selectivecoursescore/SelectiveCourseScoreUpdate", "SelectiveCourseScore", oSelectiveCourseScore);
    }
}
