 ...
 * @author Howard
 */
package universityrecruit.enterprise.studentsearch.student.controller;
...
@Controller
@RequestMapping(value = "/enterprise/studentsearch/student")
public class EntStuStudentController extends BaseController {

    @Resource(name = "EntStuStudentService")
    private IStudentService oiStudentService;

    @Autowired
    public EntStuStudentController(IStudentService oTempStudentService){
    ...
    public String searchAll(Model model, @RequestParam(required = true) Integer pageNum) {
        ...
        return "/enterprise/studentsearch/student/StudentList";
    }
    ...
    public ModelAndView addForward() throws Exception {
        return new ModelAndView("/enterprise/studentsearch/student/StudentAdd");
    }
    ...
    public ModelAndView updateForward(@RequestParam Integer testTableId) throws Exception {
        ...
        return new ModelAndView("/enterprise/studentsearch/student/StudentUpdate", "Student", oStudent);
    }
}
