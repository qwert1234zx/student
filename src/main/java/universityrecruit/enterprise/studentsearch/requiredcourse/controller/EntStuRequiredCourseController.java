 ...
 * @author Howard
 */
package universityrecruit.enterprise.studentsearch.requiredcourse.controller;
...
@Controller
@RequestMapping(value = "/enterprise/studentsearch/requiredcourse")
public class EntStuRequiredCourseController extends BaseController {

    @Resource(name = "EntStuRequiredCourseService")
    private IRequiredCourseService oiRequiredCourseService;

    @Autowired
    public EntStuRequiredCourseController(IRequiredCourseService oTempRequiredCourseService){
    ...
    public String searchAll(Model model, @RequestParam(required = true) Integer pageNum) {
        ...
        return "/enterprise/studentsearch/requiredcourse/RequiredCourseList";
    }
    ...
    public ModelAndView addForward() throws Exception {
        return new ModelAndView("/enterprise/studentsearch/requiredcourse/RequiredCourseAdd");
    }
    ...
    public ModelAndView updateForward(@RequestParam Integer testTableId) throws Exception {
        ...
        return new ModelAndView("/enterprise/studentsearch/requiredcourse/RequiredCourseUpdate", "RequiredCourse", oRequiredCourse);
    }
}
