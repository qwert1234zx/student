 ...
 * @author Howard
 */
package universityrecruit.enterprise.studentsearch.standardcourse.controller;
...
@Controller
@RequestMapping(value = "/enterprise/studentsearch/standardcourse")
public class EntStuStandardCourseController extends BaseController {

    @Resource(name = "EntStuStandardCourseService")
    private IStandardCourseService oiStandardCourseService;

    @Autowired
    public EntStuStandardCourseController(IStandardCourseService oTempStandardCourseService){
    ...
    public String searchAll(Model model, @RequestParam(required = true) Integer pageNum) {
        ...
        return "/enterprise/studentsearch/standardcourse/StandardCourseList";
    }
    ...
    public ModelAndView addForward() throws Exception {
        return new ModelAndView("/enterprise/studentsearch/standardcourse/StandardCourseAdd");
    }
    ...
    public ModelAndView updateForward(@RequestParam Integer testTableId) throws Exception {
        ...
        return new ModelAndView("/enterprise/studentsearch/standardcourse/StandardCourseUpdate", "StandardCourse", oStandardCourse);
    }
}
