 ...
 * @author Howard
 */
package universityrecruit.enterprise.studentsearch.requiredcoursescore.controller;
...
@Controller
@RequestMapping(value = "/enterprise/studentsearch/requiredcoursescore")
public class EntStuRequiredCourseScoreController extends BaseController {

    @Resource(name = "EntStuRequiredCourseScoreService")
    private IRequiredCourseScoreService oiRequiredCourseScoreService;

    @Autowired
    public EntStuRequiredCourseScoreController(IRequiredCourseScoreService oTempRequiredCourseScoreService){
    ...
    public String searchAll(Model model, @RequestParam(required = true) Integer pageNum) {
        ...
        return "/enterprise/studentsearch/requiredcoursescore/RequiredCourseScoreList";
    }
    ...
    public ModelAndView addForward() throws Exception {
        return new ModelAndView("/enterprise/studentsearch/requiredcoursescore/RequiredCourseScoreAdd");
    }
    ...
    public ModelAndView updateForward(@RequestParam Integer testTableId) throws Exception {
        ...
        return new ModelAndView("/enterprise/studentsearch/requiredcoursescore/RequiredCourseScoreUpdate", "RequiredCourseScore", oRequiredCourseScore);
    }
}
