 ...
 * @author Howard
 */
package universityrecruit.enterprise.recruitinformationmanagement.job.controller;
...
@Controller
@RequestMapping(value = "/enterprise/recruitinformationmanagement/job")
public class EntRecJobController extends BaseController {

    @Resource(name = "EntRecJobService")
    private IJobService oiJobService;

    @Autowired
    public EntRecJobController(IJobService oTempJobService){
    ...
    public String searchAll(Model model, @RequestParam(required = true) Integer pageNum) {
        ...
        return "/enterprise/recruitinformationmanagement/job/JobList";
    }
    ...
    public ModelAndView addForward() throws Exception {
        return new ModelAndView("/enterprise/recruitinformationmanagement/job/JobAdd");
    }
    ...
    public ModelAndView updateForward(@RequestParam Integer testTableId) throws Exception {
        ...
        return new ModelAndView("/enterprise/recruitinformationmanagement/job/JobUpdate", "Job", oJob);
    }
}
