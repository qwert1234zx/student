 ...
 * @author Howard
 */
package universityrecruit.enterprise.recruitinformationmanagement.enterprise.controller;
...
@Controller
@RequestMapping(value = "/enterprise/recruitinformationmanagement/enterprise")
public class EntRecEnterpriseController extends BaseController {

    @Resource(name = "EntRecEnterpriseService")
    private IEnterpriseService oiEnterpriseService;

    @Autowired
    public EntRecEnterpriseController(IEnterpriseService oTempEnterpriseService){
    ...
    public String searchAll(Model model, @RequestParam(required = true) Integer pageNum) {
        ...
        return "/enterprise/recruitinformationmanagement/enterprise/EnterpriseList";
    }
    ...
    public ModelAndView addForward() throws Exception {
        return new ModelAndView("/enterprise/recruitinformationmanagement/enterprise/EnterpriseAdd");
    }
    ...
    public ModelAndView updateForward(@RequestParam Integer testTableId) throws Exception {
        ...
        return new ModelAndView("/enterprise/recruitinformationmanagement/enterprise/EnterpriseUpdate", "Enterprise", oEnterprise);
    }
}
