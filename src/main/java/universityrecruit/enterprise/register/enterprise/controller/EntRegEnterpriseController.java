 ...
 * @author Howard
 */
package universityrecruit.enterprise.register.enterprise.controller;
...
@Controller
@RequestMapping(value = "/enterprise/register/enterprise")
public class EntRegEnterpriseController extends BaseController {

    @Resource(name = "EntRegEnterpriseService")
    private IEnterpriseService oiEnterpriseService;

    @Autowired
    public EntRegEnterpriseController(IEnterpriseService oTempEnterpriseService){
    ...
    public String searchAll(Model model, @RequestParam(required = true) Integer pageNum) {
        ...
        return "/enterprise/register/enterprise/EnterpriseList";
    }
    ...
    public ModelAndView addForward() throws Exception {
        return new ModelAndView("/enterprise/register/enterprise/EnterpriseAdd");
    }
    ...
    public ModelAndView updateForward(@RequestParam Integer testTableId) throws Exception {
        ...
        return new ModelAndView("/enterprise/register/enterprise/EnterpriseUpdate", "Enterprise", oEnterprise);
    }
}
