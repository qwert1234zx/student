 ...
 * @author Howard
 */
package universityrecruit.enterprise.statistics.province.controller;
...
@Controller
@RequestMapping(value = "/enterprise/statistics/province")
public class EntStaProvinceController extends BaseController {

    @Resource(name = "EntStaProvinceService")
    private IProvinceService oiProvinceService;

    @Autowired
    public EntStaProvinceController(IProvinceService oTempProvinceService){
    ...
    public String searchAll(Model model, @RequestParam(required = true) Integer pageNum) {
        ...
        return "/enterprise/statistics/province/ProvinceList";
    }
    ...
    public ModelAndView addForward() throws Exception {
        return new ModelAndView("/enterprise/statistics/province/ProvinceAdd");
    }
    ...
    public ModelAndView updateForward(@RequestParam Integer testTableId) throws Exception {
        ...
        return new ModelAndView("/enterprise/statistics/province/ProvinceUpdate", "Province", oProvince);
    }
}
