 ...
 * @author Howard
 */
package universityrecruit.enterprise.statistics.specialty.controller;
...
@Controller
@RequestMapping(value = "/enterprise/statistics/specialty")
public class EntStaSpecialtyController extends BaseController {

    @Resource(name = "EntStaSpecialtyService")
    private ISpecialtyService oiSpecialtyService;

    @Autowired
    public EntStaSpecialtyController(ISpecialtyService oTempSpecialtyService){
    ...
    public String searchAll(Model model, @RequestParam(required = true) Integer pageNum) {
        ...
        return "/enterprise/statistics/specialty/SpecialtyList";
    }
    ...
    public ModelAndView addForward() throws Exception {
        return new ModelAndView("/enterprise/statistics/specialty/SpecialtyAdd");
    }
    ...
    public ModelAndView updateForward(@RequestParam Integer testTableId) throws Exception {
        ...
        return new ModelAndView("/enterprise/statistics/specialty/SpecialtyUpdate", "Specialty", oSpecialty);
    }
}
