 ...
 * @author Howard
 */
package universityrecruit.enterprise.statistics.standardcourse.controller;
...
@Controller
@RequestMapping(value = "/enterprise/statistics/standardcourse")
public class EntStaStandardCourseController extends BaseController {

    @Resource(name = "EntStaStandardCourseService")
    private IStandardCourseService oiStandardCourseService;

    @Autowired
    public EntStaStandardCourseController(IStandardCourseService oTempStandardCourseService){
    ...
    public String searchAll(Model model, @RequestParam(required = true) Integer pageNum) {
        ...
        return "/enterprise/statistics/standardcourse/StandardCourseList";
    }
    ...
    public ModelAndView addForward() throws Exception {
        return new ModelAndView("/enterprise/statistics/standardcourse/StandardCourseAdd");
    }
    ...
    public ModelAndView updateForward(@RequestParam Integer testTableId) throws Exception {
        ...
        return new ModelAndView("/enterprise/statistics/standardcourse/StandardCourseUpdate", "StandardCourse", oStandardCourse);
    }
}
