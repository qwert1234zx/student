 ...
 * @author Howard
 */
package universityrecruit.enterprise.statistics.requiredcourse.controller;
...
@Controller
@RequestMapping(value = "/enterprise/statistics/requiredcourse")
public class EntStaRequiredCourseController extends BaseController {

    @Resource(name = "EntStaRequiredCourseService")
    private IRequiredCourseService oiRequiredCourseService;

    @Autowired
    public EntStaRequiredCourseController(IRequiredCourseService oTempRequiredCourseService){
    ...
    public String searchAll(Model model, @RequestParam(required = true) Integer pageNum) {
        ...
        return "/enterprise/statistics/requiredcourse/RequiredCourseList";
    }
    ...
    public ModelAndView addForward() throws Exception {
        return new ModelAndView("/enterprise/statistics/requiredcourse/RequiredCourseAdd");
    }
    ...
    public ModelAndView updateForward(@RequestParam Integer testTableId) throws Exception {
        ...
        return new ModelAndView("/enterprise/statistics/requiredcourse/RequiredCourseUpdate", "RequiredCourse", oRequiredCourse);
    }
}
