 ...
 * @author Howard
 */
package universityrecruit.enterprise.statistics.interviewrecord.controller;
...
@Controller
@RequestMapping(value = "/enterprise/statistics/interviewrecord")
public class EntStaInterviewRecordController extends BaseController {

    @Resource(name = "EntStaInterviewRecordService")
    private IInterviewRecordService oiInterviewRecordService;

    @Autowired
    public EntStaInterviewRecordController(IInterviewRecordService oTempInterviewRecordService){
    ...
    public String searchAll(Model model, @RequestParam(required = true) Integer pageNum) {
        ...
        return "/enterprise/statistics/interviewrecord/InterviewRecordList";
    }
    ...
    @ResponseBody
    public PageWriter<InterviewRecord> search(@RequestParam(required = true) Integer pageNum,  @RequestParam(required = true) String interviewResult, @RequestParam(required = true) String interviewerMobile, @RequestParam(required = true) String interviewer, @RequestParam(required = true) Integer interviewStatus, @RequestParam(required = true) Date interviewTime, @RequestParam(required = true) Integer studentID, @RequestParam(required = true) Integer enterpriseID) {
        PageWriter<InterviewRecord> pageWriter = null;
        try {
            //拼接查询条件Map
            Map<String, Object> condition = new HashMap<String, Object>();
			
			condition.put("InterviewResult",interviewResult);
    ...
    public ModelAndView addForward() throws Exception {
        return new ModelAndView("/enterprise/statistics/interviewrecord/InterviewRecordAdd");
    }
    ...
    public ModelAndView updateForward(@RequestParam Integer testTableId) throws Exception {
        ...
        return new ModelAndView("/enterprise/statistics/interviewrecord/InterviewRecordUpdate", "InterviewRecord", oInterviewRecord);
    }
}
