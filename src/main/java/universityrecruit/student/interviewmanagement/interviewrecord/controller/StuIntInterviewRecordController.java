 ...
 * @author Howard
 */
package universityrecruit.student.interviewmanagement.interviewrecord.controller;
...
@Controller
@RequestMapping(value = "/student/interviewmanagement/interviewrecord")
public class StuIntInterviewRecordController extends BaseController {

    @Resource(name = "StuIntInterviewRecordService")
    private IInterviewRecordService oiInterviewRecordService;

    @Autowired
    public StuIntInterviewRecordController(IInterviewRecordService oTempInterviewRecordService){
    ...
    public String searchAll(Model model, @RequestParam(required = true) Integer pageNum) {
        ...
        return "/student/interviewmanagement/interviewrecord/InterviewRecordList";
    }
    ...
    public ModelAndView addForward() throws Exception {
        return new ModelAndView("/student/interviewmanagement/interviewrecord/InterviewRecordAdd");
    }
    ...
    public ModelAndView updateForward(@RequestParam Integer testTableId) throws Exception {
        ...
        return new ModelAndView("/student/interviewmanagement/interviewrecord/InterviewRecordUpdate", "InterviewRecord", oInterviewRecord);
    }
}
