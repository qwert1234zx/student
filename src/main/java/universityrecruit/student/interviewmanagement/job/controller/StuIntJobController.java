 ...
 * @author Howard
 */
package universityrecruit.student.interviewmanagement.job.controller;
...
@Controller
@RequestMapping(value = "/student/interviewmanagement/job")
public class StuIntJobController extends BaseController {

    @Resource(name = "StuIntJobService")
    private IJobService oiJobService;

    @Autowired
    public StuIntJobController(IJobService oTempJobService){
    ...
    public String searchAll(Model model, @RequestParam(required = true) Integer pageNum) {
        ...
        return "/student/interviewmanagement/job/JobList";
    }
    ...
    public ModelAndView addForward() throws Exception {
        return new ModelAndView("/student/interviewmanagement/job/JobAdd");
    }
    ...
    public ModelAndView updateForward(@RequestParam Integer testTableId) throws Exception {
        ...
        return new ModelAndView("/student/interviewmanagement/job/JobUpdate", "Job", oJob);
    }
}
