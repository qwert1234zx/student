 ...
 * @author Howard
 */
package universityrecruit.student.infomationmanagement.student.controller;
...
@Controller
@RequestMapping(value = "/student/infomationmanagement/student")
public class StuInfStudentController extends BaseController {

    @Resource(name = "StuInfStudentService")
    private IStudentService oiStudentService;

    @Autowired
    public StuInfStudentController(IStudentService oTempStudentService){
    ...
    public String searchAll(Model model, @RequestParam(required = true) Integer pageNum) {
        ...
        return "/student/infomationmanagement/student/StudentList";
    }
    ...
    public ModelAndView addForward() throws Exception {
        return new ModelAndView("/student/infomationmanagement/student/StudentAdd");
    }
    ...
    public ModelAndView updateForward(@RequestParam Integer testTableId) throws Exception {
        ...
        return new ModelAndView("/student/infomationmanagement/student/StudentUpdate", "Student", oStudent);
    }
}
