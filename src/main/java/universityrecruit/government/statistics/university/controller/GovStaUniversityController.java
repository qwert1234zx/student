 ...
 * @author Howard
 */
package universityrecruit.government.statistics.university.controller;
...
@Controller
@RequestMapping(value = "/government/statistics/university")
public class GovStaUniversityController extends BaseController {

    @Resource(name = "GovStaUniversityService")
    private IUniversityService oiUniversityService;

    @Autowired
    public GovStaUniversityController(IUniversityService oTempUniversityService){
    ...
    public String searchAll(Model model, @RequestParam(required = true) Integer pageNum) {
        ...
        return "/government/statistics/university/UniversityList";
    }
    ...
    public ModelAndView addForward() throws Exception {
        return new ModelAndView("/government/statistics/university/UniversityAdd");
    }
    ...
    public ModelAndView updateForward(@RequestParam Integer testTableId) throws Exception {
        ...
        return new ModelAndView("/government/statistics/university/UniversityUpdate", "University", oUniversity);
    }
}
