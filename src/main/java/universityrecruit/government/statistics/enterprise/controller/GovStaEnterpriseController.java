 ...
 * @author Howard
 */
package universityrecruit.government.statistics.enterprise.controller;
...
@Controller
@RequestMapping(value = "/government/statistics/enterprise")
public class GovStaEnterpriseController extends BaseController {

    @Resource(name = "GovStaEnterpriseService")
    private IEnterpriseService oiEnterpriseService;

    @Autowired
    public GovStaEnterpriseController(IEnterpriseService oTempEnterpriseService){
    ...
    public String searchAll(Model model, @RequestParam(required = true) Integer pageNum) {
        ...
        return "/government/statistics/enterprise/EnterpriseList";
    }
    ...
    public ModelAndView addForward() throws Exception {
        return new ModelAndView("/government/statistics/enterprise/EnterpriseAdd");
    }
    ...
    public ModelAndView updateForward(@RequestParam Integer testTableId) throws Exception {
        ...
        return new ModelAndView("/government/statistics/enterprise/EnterpriseUpdate", "Enterprise", oEnterprise);
    }
}
