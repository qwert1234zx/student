 ...
 * @author Howard
 */
package universityrecruit.government.statistics.interviewrecord.controller;
...
@Controller
@RequestMapping(value = "/government/statistics/interviewrecord")
public class GovStaInterviewRecordController extends BaseController {

    @Resource(name = "GovStaInterviewRecordService")
    private IInterviewRecordService oiInterviewRecordService;

    @Autowired
    public GovStaInterviewRecordController(IInterviewRecordService oTempInterviewRecordService){
    ...
    public String searchAll(Model model, @RequestParam(required = true) Integer pageNum) {
        ...
        return "/government/statistics/interviewrecord/InterviewRecordList";
    }
    ...
    public ModelAndView addForward() throws Exception {
        return new ModelAndView("/government/statistics/interviewrecord/InterviewRecordAdd");
    }
    ...
    public ModelAndView updateForward(@RequestParam Integer testTableId) throws Exception {
        ...
        return new ModelAndView("/government/statistics/interviewrecord/InterviewRecordUpdate", "InterviewRecord", oInterviewRecord);
    }
}
