 ...
 * @author Howard
 */
package universityrecruit.government.statistics.student.controller;
...
@Controller
@RequestMapping(value = "/government/statistics/student")
public class GovStaStudentController extends BaseController {

    @Resource(name = "GovStaStudentService")
    private IStudentService oiStudentService;

    @Autowired
    public GovStaStudentController(IStudentService oTempStudentService){
    ...
    public String searchAll(Model model, @RequestParam(required = true) Integer pageNum) {
        ...
        return "/government/statistics/student/StudentList";
    }
    ...
    public ModelAndView addForward() throws Exception {
        return new ModelAndView("/government/statistics/student/StudentAdd");
    }
    ...
    public ModelAndView updateForward(@RequestParam Integer testTableId) throws Exception {
        ...
        return new ModelAndView("/government/statistics/student/StudentUpdate", "Student", oStudent);
    }
}
