 ...
 * @author Howard
 */
package universityrecruit.government.statistics.specialty.controller;
...
@Controller
@RequestMapping(value = "/government/statistics/specialty")
public class GovStaSpecialtyController extends BaseController {

    @Resource(name = "GovStaSpecialtyService")
    private ISpecialtyService oiSpecialtyService;

    @Autowired
    public GovStaSpecialtyController(ISpecialtyService oTempSpecialtyService){
    ...
    public String searchAll(Model model, @RequestParam(required = true) Integer pageNum) {
        ...
        return "/government/statistics/specialty/SpecialtyList";
    }
    ...
    public ModelAndView addForward() throws Exception {
        return new ModelAndView("/government/statistics/specialty/SpecialtyAdd");
    }
    ...
    public ModelAndView updateForward(@RequestParam Integer testTableId) throws Exception {
        ...
        return new ModelAndView("/government/statistics/specialty/SpecialtyUpdate", "Specialty", oSpecialty);
    }
}
