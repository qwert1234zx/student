 ...
 * @author Howard
 */
package universityrecruit.university.scoremanagement.requiredcourse.controller;
...
@Controller
@RequestMapping(value = "/university/scoremanagement/requiredcourse")
public class UniScoRequiredCourseController extends BaseController {

    @Resource(name = "UniScoRequiredCourseService")
    private IRequiredCourseService oiRequiredCourseService;

    @Autowired
    public UniScoRequiredCourseController(IRequiredCourseService oTempRequiredCourseService){
    ...
    public String searchAll(Model model, @RequestParam(required = true) Integer pageNum) {
        ...
        return "/university/scoremanagement/requiredcourse/RequiredCourseList";
    }
    ...
    public ModelAndView addForward() throws Exception {
        return new ModelAndView("/university/scoremanagement/requiredcourse/RequiredCourseAdd");
    }
    ...
    public ModelAndView updateForward(@RequestParam Integer testTableId) throws Exception {
        ...
        return new ModelAndView("/university/scoremanagement/requiredcourse/RequiredCourseUpdate", "RequiredCourse", oRequiredCourse);
    }
}
