 ...
 * @author Howard
 */
package universityrecruit.university.scoremanagement.student.controller;
...
@Controller
@RequestMapping(value = "/university/scoremanagement/student")
public class UniScoStudentController extends BaseController {

    @Resource(name = "UniScoStudentService")
    private IStudentService oiStudentService;

    @Autowired
    public UniScoStudentController(IStudentService oTempStudentService){
    ...
    public String searchAll(Model model, @RequestParam(required = true) Integer pageNum) {
        ...
        return "/university/scoremanagement/student/StudentList";
    }
    ...
    public ModelAndView addForward() throws Exception {
        return new ModelAndView("/university/scoremanagement/student/StudentAdd");
    }
    ...
    public ModelAndView updateForward(@RequestParam Integer testTableId) throws Exception {
        ...
        return new ModelAndView("/university/scoremanagement/student/StudentUpdate", "Student", oStudent);
    }
}
