 ...
 * @author Howard
 */
package universityrecruit.university.scoremanagement.requiredcoursescore.controller;
...
@Controller
@RequestMapping(value = "/university/scoremanagement/requiredcoursescore")
public class UniScoRequiredCourseScoreController extends BaseController {

    @Resource(name = "UniScoRequiredCourseScoreService")
    private IRequiredCourseScoreService oiRequiredCourseScoreService;

    @Autowired
    public UniScoRequiredCourseScoreController(IRequiredCourseScoreService oTempRequiredCourseScoreService){
    ...
    public String searchAll(Model model, @RequestParam(required = true) Integer pageNum) {
        ...
        return "/university/scoremanagement/requiredcoursescore/RequiredCourseScoreList";
    }
    ...
    public ModelAndView addForward() throws Exception {
        return new ModelAndView("/university/scoremanagement/requiredcoursescore/RequiredCourseScoreAdd");
    }
    ...
    public ModelAndView updateForward(@RequestParam Integer testTableId) throws Exception {
        ...
        return new ModelAndView("/university/scoremanagement/requiredcoursescore/RequiredCourseScoreUpdate", "RequiredCourseScore", oRequiredCourseScore);
    }
}
