 ...
 * @author Howard
 */
package universityrecruit.university.studentmanagement.specialty.controller;
...
@Controller
@RequestMapping(value = "/university/studentmanagement/specialty")
public class UniStuSpecialtyController extends BaseController {

    @Resource(name = "UniStuSpecialtyService")
    private ISpecialtyService oiSpecialtyService;

    @Autowired
    public UniStuSpecialtyController(ISpecialtyService oTempSpecialtyService){
    ...
    public String searchAll(Model model, @RequestParam(required = true) Integer pageNum) {
        ...
        return "/university/studentmanagement/specialty/SpecialtyList";
    }
    ...
    public ModelAndView addForward() throws Exception {
        return new ModelAndView("/university/studentmanagement/specialty/SpecialtyAdd");
    }
    ...
    public ModelAndView updateForward(@RequestParam Integer testTableId) throws Exception {
        ...
        return new ModelAndView("/university/studentmanagement/specialty/SpecialtyUpdate", "Specialty", oSpecialty);
    }
}
