 ...
 * @author Howard
 */
package universityrecruit.university.studentmanagement.academy.controller;
...
@Controller
@RequestMapping(value = "/university/studentmanagement/academy")
public class UniStuAcademyController extends BaseController {

    @Resource(name = "UniStuAcademyService")
    private IAcademyService oiAcademyService;

    @Autowired
    public UniStuAcademyController(IAcademyService oTempAcademyService){
    ...
    public String searchAll(Model model, @RequestParam(required = true) Integer pageNum) {
        ...
        return "/university/studentmanagement/academy/AcademyList";
    }
    ...
    public ModelAndView addForward() throws Exception {
        return new ModelAndView("/university/studentmanagement/academy/AcademyAdd");
    }
    ...
    public ModelAndView updateForward(@RequestParam Integer testTableId) throws Exception {
        ...
        return new ModelAndView("/university/studentmanagement/academy/AcademyUpdate", "Academy", oAcademy);
    }
}
