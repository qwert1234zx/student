 ...
 * @author Howard
 */
package universityrecruit.university.studentmanagement.student.controller;
...
@Controller
@RequestMapping(value = "/university/studentmanagement/student")
public class UniStuStudentController extends BaseController {

    @Resource(name = "UniStuStudentService")
    private IStudentService oiStudentService;

    @Autowired
    public UniStuStudentController(IStudentService oTempStudentService){
    ...
    public String searchAll(Model model, @RequestParam(required = true) Integer pageNum) {
        ...
        return "/university/studentmanagement/student/StudentList";
    }
    ...
    public ModelAndView addForward() throws Exception {
        return new ModelAndView("/university/studentmanagement/student/StudentAdd");
    }
    ...
    public ModelAndView updateForward(@RequestParam Integer testTableId) throws Exception {
        ...
        return new ModelAndView("/university/studentmanagement/student/StudentUpdate", "Student", oStudent);
    }
}
