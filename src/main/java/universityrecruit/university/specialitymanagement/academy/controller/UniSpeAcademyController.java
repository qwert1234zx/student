 ...
 * @author Howard
 */
package universityrecruit.university.specialitymanagement.academy.controller;
...
@Controller
@RequestMapping(value = "/university/specialitymanagement/academy")
public class UniSpeAcademyController extends BaseController {

    @Resource(name = "UniSpeAcademyService")
    private IAcademyService oiAcademyService;

    @Autowired
    public UniSpeAcademyController(IAcademyService oTempAcademyService){
    ...
    public String searchAll(Model model, @RequestParam(required = true) Integer pageNum) {
        ...
        return "/university/specialitymanagement/academy/AcademyList";
    }
    ...
    public ModelAndView addForward() throws Exception {
        return new ModelAndView("/university/specialitymanagement/academy/AcademyAdd");
    }
    ...
    public ModelAndView updateForward(@RequestParam Integer testTableId) throws Exception {
        ...
        return new ModelAndView("/university/specialitymanagement/academy/AcademyUpdate", "Academy", oAcademy);
    }
}
