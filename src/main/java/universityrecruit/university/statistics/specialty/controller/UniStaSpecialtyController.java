 ...
 * @author Howard
 */
package universityrecruit.university.statistics.specialty.controller;
...
@Controller
@RequestMapping(value = "/university/statistics/specialty")
public class UniStaSpecialtyController extends BaseController {

    @Resource(name = "UniStaSpecialtyService")
    private ISpecialtyService oiSpecialtyService;

    @Autowired
    public UniStaSpecialtyController(ISpecialtyService oTempSpecialtyService){
    ...
    public String searchAll(Model model, @RequestParam(required = true) Integer pageNum) {
        ...
        return "/university/statistics/specialty/SpecialtyList";
    }
    ...
    public ModelAndView addForward() throws Exception {
        return new ModelAndView("/university/statistics/specialty/SpecialtyAdd");
    }
    ...
    public ModelAndView updateForward(@RequestParam Integer testTableId) throws Exception {
        ...
        return new ModelAndView("/university/statistics/specialty/SpecialtyUpdate", "Specialty", oSpecialty);
    }
}
