 ...
 * @author Howard
 */
package universityrecruit.university.statistics.requiredcoursescore.controller;
...
@Controller
@RequestMapping(value = "/university/statistics/requiredcoursescore")
public class UniStaRequiredCourseScoreController extends BaseController {

    @Resource(name = "UniStaRequiredCourseScoreService")
    private IRequiredCourseScoreService oiRequiredCourseScoreService;

    @Autowired
    public UniStaRequiredCourseScoreController(IRequiredCourseScoreService oTempRequiredCourseScoreService){
    ...
    public String searchAll(Model model, @RequestParam(required = true) Integer pageNum) {
        ...
        return "/university/statistics/requiredcoursescore/RequiredCourseScoreList";
    }
    ...
    public ModelAndView addForward() throws Exception {
        return new ModelAndView("/university/statistics/requiredcoursescore/RequiredCourseScoreAdd");
    }
    ...
    public ModelAndView updateForward(@RequestParam Integer testTableId) throws Exception {
        ...
        return new ModelAndView("/university/statistics/requiredcoursescore/RequiredCourseScoreUpdate", "RequiredCourseScore", oRequiredCourseScore);
    }
}
