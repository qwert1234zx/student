 ...
 * @author Howard
 */
package universityrecruit.university.statistics.province.controller;
...
@Controller
@RequestMapping(value = "/university/statistics/province")
public class UniStaProvinceController extends BaseController {

    @Resource(name = "UniStaProvinceService")
    private IProvinceService oiProvinceService;

    @Autowired
    public UniStaProvinceController(IProvinceService oTempProvinceService){
    ...
    public String searchAll(Model model, @RequestParam(required = true) Integer pageNum) {
        ...
        return "/university/statistics/province/ProvinceList";
    }
    ...
    public ModelAndView addForward() throws Exception {
        return new ModelAndView("/university/statistics/province/ProvinceAdd");
    }
    ...
    public ModelAndView updateForward(@RequestParam Integer testTableId) throws Exception {
        ...
        return new ModelAndView("/university/statistics/province/ProvinceUpdate", "Province", oProvince);
    }
}
