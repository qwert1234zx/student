 ...
 * @author Howard
 */
package universityrecruit.university.statistics.interviewrecord.controller;
...
@Controller
@RequestMapping(value = "/university/statistics/interviewrecord")
public class UniStaInterviewRecordController extends BaseController {

    @Resource(name = "UniStaInterviewRecordService")
    private IInterviewRecordService oiInterviewRecordService;

    @Autowired
    public UniStaInterviewRecordController(IInterviewRecordService oTempInterviewRecordService){
    ...
    public String searchAll(Model model, @RequestParam(required = true) Integer pageNum) {
        ...
        return "/university/statistics/interviewrecord/InterviewRecordList";
    }
    ...
    public ModelAndView addForward() throws Exception {
        return new ModelAndView("/university/statistics/interviewrecord/InterviewRecordAdd");
    }
    ...
    public ModelAndView updateForward(@RequestParam Integer testTableId) throws Exception {
        ...
        return new ModelAndView("/university/statistics/interviewrecord/InterviewRecordUpdate", "InterviewRecord", oInterviewRecord);
    }
}
