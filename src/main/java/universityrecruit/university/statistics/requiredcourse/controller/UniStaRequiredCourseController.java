 ...
 * @author Howard
 */
package universityrecruit.university.statistics.requiredcourse.controller;
...
@Controller
@RequestMapping(value = "/university/statistics/requiredcourse")
public class UniStaRequiredCourseController extends BaseController {

    @Resource(name = "UniStaRequiredCourseService")
    private IRequiredCourseService oiRequiredCourseService;

    @Autowired
    public UniStaRequiredCourseController(IRequiredCourseService oTempRequiredCourseService){
    ...
    public String searchAll(Model model, @RequestParam(required = true) Integer pageNum) {
        ...
        return "/university/statistics/requiredcourse/RequiredCourseList";
    }
    ...
    public ModelAndView addForward() throws Exception {
        return new ModelAndView("/university/statistics/requiredcourse/RequiredCourseAdd");
    }
    ...
    public ModelAndView updateForward(@RequestParam Integer testTableId) throws Exception {
        ...
        return new ModelAndView("/university/statistics/requiredcourse/RequiredCourseUpdate", "RequiredCourse", oRequiredCourse);
    }
}
