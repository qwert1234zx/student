 ...
 * @author Howard
 */
package universityrecruit.university.statistics.enterprise.controller;
...
@Controller
@RequestMapping(value = "/university/statistics/enterprise")
public class UniStaEnterpriseController extends BaseController {

    @Resource(name = "UniStaEnterpriseService")
    private IEnterpriseService oiEnterpriseService;

    @Autowired
    public UniStaEnterpriseController(IEnterpriseService oTempEnterpriseService){
    ...
    public String searchAll(Model model, @RequestParam(required = true) Integer pageNum) {
        ...
        return "/university/statistics/enterprise/EnterpriseList";
    }
    ...
    public ModelAndView addForward() throws Exception {
        return new ModelAndView("/university/statistics/enterprise/EnterpriseAdd");
    }
    ...
    public ModelAndView updateForward(@RequestParam Integer testTableId) throws Exception {
        ...
        return new ModelAndView("/university/statistics/enterprise/EnterpriseUpdate", "Enterprise", oEnterprise);
    }
}
