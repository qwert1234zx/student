 ...
 * @author Howard
 */
package universityrecruit.university.statistics.academy.controller;
...
@Controller
@RequestMapping(value = "/university/statistics/academy")
public class UniStaAcademyController extends BaseController {

    @Resource(name = "UniStaAcademyService")
    private IAcademyService oiAcademyService;

    @Autowired
    public UniStaAcademyController(IAcademyService oTempAcademyService){
    ...
    public String searchAll(Model model, @RequestParam(required = true) Integer pageNum) {
        ...
        return "/university/statistics/academy/AcademyList";
    }
    ...
    public ModelAndView addForward() throws Exception {
        return new ModelAndView("/university/statistics/academy/AcademyAdd");
    }
    ...
    public ModelAndView updateForward(@RequestParam Integer testTableId) throws Exception {
        ...
        return new ModelAndView("/university/statistics/academy/AcademyUpdate", "Academy", oAcademy);
    }
}
