 ...
 * @author Howard
 */
package universityrecruit.university.statistics.student.controller;
...
@Controller
@RequestMapping(value = "/university/statistics/student")
public class UniStaStudentController extends BaseController {

    @Resource(name = "UniStaStudentService")
    private IStudentService oiStudentService;

    @Autowired
    public UniStaStudentController(IStudentService oTempStudentService){
    ...
    public String searchAll(Model model, @RequestParam(required = true) Integer pageNum) {
        ...
        return "/university/statistics/student/StudentList";
    }
    ...
    public ModelAndView addForward() throws Exception {
        return new ModelAndView("/university/statistics/student/StudentAdd");
    }
    ...
    public ModelAndView updateForward(@RequestParam Integer testTableId) throws Exception {
        ...
        return new ModelAndView("/university/statistics/student/StudentUpdate", "Student", oStudent);
    }
}
