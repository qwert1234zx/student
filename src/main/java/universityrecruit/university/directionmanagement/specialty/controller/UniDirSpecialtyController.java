 ...
 * @author Howard
 */
package universityrecruit.university.directionmanagement.specialty.controller;
...
@Controller
@RequestMapping(value = "/university/directionmanagement/specialty")
public class UniDirSpecialtyController extends BaseController {

    @Resource(name = "UniDirSpecialtyService")
    private ISpecialtyService oiSpecialtyService;

    @Autowired
    public UniDirSpecialtyController(ISpecialtyService oTempSpecialtyService){
    ...
    public String searchAll(Model model, @RequestParam(required = true) Integer pageNum) {
        ...
        return "/university/directionmanagement/specialty/SpecialtyList";
    }
    ...
    public ModelAndView addForward() throws Exception {
        return new ModelAndView("/university/directionmanagement/specialty/SpecialtyAdd");
    }
    ...
    public ModelAndView updateForward(@RequestParam Integer testTableId) throws Exception {
        ...
        return new ModelAndView("/university/directionmanagement/specialty/SpecialtyUpdate", "Specialty", oSpecialty);
    }
}
