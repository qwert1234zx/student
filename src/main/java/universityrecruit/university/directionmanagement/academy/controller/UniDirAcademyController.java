 ...
 * @author Howard
 */
package universityrecruit.university.directionmanagement.academy.controller;
...
@Controller
@RequestMapping(value = "/university/directionmanagement/academy")
public class UniDirAcademyController extends BaseController {

    @Resource(name = "UniDirAcademyService")
    private IAcademyService oiAcademyService;

    @Autowired
    public UniDirAcademyController(IAcademyService oTempAcademyService){
    ...
    public String searchAll(Model model, @RequestParam(required = true) Integer pageNum) {
        ...
        return "/university/directionmanagement/academy/AcademyList";
    }
    ...
    public ModelAndView addForward() throws Exception {
        return new ModelAndView("/university/directionmanagement/academy/AcademyAdd");
    }
    ...
    public ModelAndView updateForward(@RequestParam Integer testTableId) throws Exception {
        ...
        return new ModelAndView("/university/directionmanagement/academy/AcademyUpdate", "Academy", oAcademy);
    }
}
