 ...
 * @author Howard
 */
package universityrecruit.university.coursemanagement.standardcourse.controller;
...
@Controller
@RequestMapping(value = "/university/coursemanagement/standardcourse")
public class UniCouStandardCourseController extends BaseController {

    @Resource(name = "UniCouStandardCourseService")
    private IStandardCourseService oiStandardCourseService;

    @Autowired
    public UniCouStandardCourseController(IStandardCourseService oTempStandardCourseService){
    ...
    public String searchAll(Model model, @RequestParam(required = true) Integer pageNum) {
        ...
        return "/university/coursemanagement/standardcourse/StandardCourseList";
    }
    ...
    public ModelAndView addForward() throws Exception {
        return new ModelAndView("/university/coursemanagement/standardcourse/StandardCourseAdd");
    }
    ...
    public ModelAndView updateForward(@RequestParam Integer testTableId) throws Exception {
        ...
        return new ModelAndView("/university/coursemanagement/standardcourse/StandardCourseUpdate", "StandardCourse", oStandardCourse);
    }
}
