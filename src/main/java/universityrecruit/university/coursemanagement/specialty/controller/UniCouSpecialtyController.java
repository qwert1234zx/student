 ...
 * @author Howard
 */
package universityrecruit.university.coursemanagement.specialty.controller;
...
@Controller
@RequestMapping(value = "/university/coursemanagement/specialty")
public class UniCouSpecialtyController extends BaseController {

    @Resource(name = "UniCouSpecialtyService")
    private ISpecialtyService oiSpecialtyService;

    @Autowired
    public UniCouSpecialtyController(ISpecialtyService oTempSpecialtyService){
    ...
    public String searchAll(Model model, @RequestParam(required = true) Integer pageNum) {
        ...
        return "/university/coursemanagement/specialty/SpecialtyList";
    }
    ...
    public ModelAndView addForward() throws Exception {
        return new ModelAndView("/university/coursemanagement/specialty/SpecialtyAdd");
    }
    ...
    public ModelAndView updateForward(@RequestParam Integer testTableId) throws Exception {
        ...
        return new ModelAndView("/university/coursemanagement/specialty/SpecialtyUpdate", "Specialty", oSpecialty);
    }
}
